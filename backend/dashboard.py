...
def _overview(period_str: str = "7d") -> dict:
    ...
    be_html = (
        ...
        f'      <div style="font-family:var(--KPI); font-size: 26px; font-weight: 400; color: {progress_color}; line-height: 1; margin-top: 4px;">{progress_pct_float:.1f}%</div>'
        f'    </div>'
        f'  </div>'
        f'  '
        ...
        f'    </div>'
        f'    '
        f'    <div style="display: flex; justify-content: space-between; font-size: 11px; margin-top: 6px; color: var(--muted); font-weight: 500; padding-bottom: 12px;">'
